...
如果你改成 element-plus，直接在 JS 侧切换即可，无需追加 CSS（`@vtable-guild/vtable-guild/css/style`、`@vtable-guild/vtable-guild/css/tailwind3` 和 `@vtable-guild/vtable-guild/css/tailwind4` 均已内含所有预设样式）：
