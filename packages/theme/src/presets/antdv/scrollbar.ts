...
export const antdvScrollbarTheme = {
  slots: {
...
export type AntdvScrollbarSlots = keyof typeof antdvScrollbarTheme.slots
export type AntdvScrollbarThemeConfig = typeof antdvScrollbarTheme
