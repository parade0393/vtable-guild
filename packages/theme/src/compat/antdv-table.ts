...
export const antdvTableCompatClasses: CompatClassConfig = {
  slots: {
    ...
    expandIconExpanded: 'ant-table-row-expanded',
    expandIconCollapsed: 'ant-table-row-collapsed',
    expandIconSpaced: 'ant-table-row-spaced',
    treeExpandIcon: 'ant-table-row-expand-icon',
    treeExpandIconExpanded: 'ant-table-row-expanded',
    treeExpandIconCollapsed: 'ant-table-row-collapsed',
    treeExpandIconSpaced: 'ant-table-row-spaced',
