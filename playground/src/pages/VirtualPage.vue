...
const fixedColumns: ColumnsType<VirtualRow> = [
  ...
  { title: 'Score', dataIndex: 'score', key: 'score', width: 100, align: 'right' },
  { title: 'City', dataIndex: 'city', key: 'city', width: 120 },
  { title: 'Extra 1', dataIndex: 'name', key: 'extra1', width: 150 },
  { title: 'Extra 2', dataIndex: 'city', key: 'extra2', width: 150 },
  { title: 'Address', dataIndex: 'address', key: 'address', width: 200, fixed: 'right' },
]
  ...
  <main class="play-page">
    ...
    <section class="play-case">
      <header class="play-case__header">
        ...
        <p class="play-case__desc">10,000 行 + 固定左右列，验证横向/纵向流畅度</p>
      </header>
      <VTable
        :data-source="bigData"
